...
void setup() {
  size(600,800); // sets size of window 
  cp5 = new ControlP5(this);
  myClient=new Client(this,"192.168.1.101" ,5200); // sets client using the Arduino IP address and port number 5200
...
text("Eyes:", 220, 337);
text("Status:", 220, 450);
text("Distance:", 250, 600);
noFill();
strokeWeight(2);
rect(150, 300, 300, 350,10); // sets up graphical User interface 
